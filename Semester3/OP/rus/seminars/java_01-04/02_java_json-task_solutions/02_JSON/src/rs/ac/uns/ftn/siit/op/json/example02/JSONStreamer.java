package rs.ac.uns.ftn.siit.op.json.example02;
...
//		System.out.println(authorsBook);
	...
	public static void parseJSON(AuthorsBook authorsBook, String bookName) throws JsonParseException, IOException {
		JsonFactory jsonFactory = new JsonFactory();
